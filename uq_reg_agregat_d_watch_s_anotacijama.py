...
Sve veličine su preuzete iz dostavljene log datoteke `watch-zakuca1d-zakuca1d-{number}.log`.
                               
Prikazane veličine su:
{signals_list}

<div class="wide-graph">
    <iframe src="{{{{ site.baseurl }}}}/watch-htmls-d/{name_of_html}" width="100%" height="800px" frameborder="0"></iframe>
</div>
"""

# FOLDER ZA MARKDOWN DATOTEKE 
output_dir = "watch-md-d"
os.makedirs(output_dir, exist_ok=True)

savepath = r"""C:\Users\larab\Documents\GitHub\uq_vn_regulacija\watch-htmls-d"""
datapath = r"""C:\Users\larab\Documents\GitHub\uq_vn_regulacija\Watch_snimke_D"""
...
timestamps_path = "C:/Users/larab/Documents/GitHub/uq_vn_regulacija/timestamps_agregat_d.xlsx"
